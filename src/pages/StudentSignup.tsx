...
export default function StudentSignup() {
  ...
  const handleSendOTP = async (e: React.FormEvent) => {
    ...
    if (existingUsers.some((u: StudentData) => u.usn === studentData.usn)) {
      setError('This USN is already registered. Please login instead.');
      return;
    }

    setIsLoading(true);

    // Generate and show OTP (for demo)
    ...
    setIsLoading(false);
    setStep('otp');
    toast.success(`OTP sent to ****${studentData.phone.slice(-4)}`);
